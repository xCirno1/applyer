...
import { filterAndSort, nextSortDir, type CellAccessors, type SortDir } from './dataTableLogic'
 ...
 * `useWorkspaceLayout.ts`: the rules live in `dataTableLogic.ts` and are tested
